...
docker buildx build --metadata-file kubearmor-relay-server.json --platform $PLATFORMS --build-arg VERSION=$VERSION --push -t $REPO:$VERSION -f $BASE_DIR/relay-server/Dockerfile .
